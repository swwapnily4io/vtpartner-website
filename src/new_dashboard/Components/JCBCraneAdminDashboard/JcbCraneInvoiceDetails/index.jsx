  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      printWindow.document.write(`
        ...
        <html>
        <head>
          <title>JCB/Crane Service Invoice</title>
          <style>
            @media print {
        ...
        <Row>
          <Col xs={12}>
            <div ref={cardRef} className="bg-white p-4">
              <Col>
                <h6 className="text-3xl mb-5">JCB/Crane Service Invoice</h6>
                ...
                <div className="flex justify-between mb-5">
                  <div className="w-full">
                    <div className="bg-blue-50 p-2 mb-4 me-4 rounded-lg">
                      ...
                      <h6 className="f-w-600 font-semibold m-2">
                        DRIVER NAME : {bookingDetails.driver_name}
                      </h6>
                    </div>
                ...
                <div className="mb-2">
                  ...
                  <ul>
                    <li className="text-gray-400 text-sm mb-2">
                      ...
                      connects customers with verified professional JCB/Crane
                      operators. We act as an intermediary to facilitate safe
                      and reliable heavy equipment services.
                    </li>
                    <li className="text-gray-400 text-sm mb-2">
                      2. Safety & Security: All our operators are verified and
                      equipment is regularly inspected to ensure operational
                      safety. However, customers are advised to follow basic
                      safety guidelines around heavy machinery.
                    </li>
                    <li className="text-gray-400 text-sm mb-2">
                      3. Fare Calculation: The total fare is calculated based on
                      service hours and base fare as per our pricing policy.
                      Additional charges may apply for extended usage or special
                      requirements.
                    </li>
                  </ul>
                </div>
...
export default JcbCraneInvoiceDetails;
