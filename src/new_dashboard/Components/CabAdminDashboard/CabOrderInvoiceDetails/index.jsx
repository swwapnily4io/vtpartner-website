...
const CabInvoiceDetails = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.save(
        `CAB_INVOICE_ORDER_ID#${bookingDetails?.order_id || "-1"}_CUSTOMER:${
        ...
        <Row>
          <Col xs={12}>
            <div ref={cardRef} className="bg-white p-4">
              <Col>
                <h6 className="text-3xl mb-5">Cab Service Invoice</h6>
                ...
                <div className="mb-2">
                  ...
                  <ul>
                    ...
                    <li className="text-gray-400 text-sm mb-2">
                      2. Safety & Security: All our drivers are verified and
                      vehicles are regularly inspected to ensure passenger
                      safety. However, passengers are advised to follow basic
                      safety guidelines.
                    </li>
                    <li className="text-gray-400 text-sm mb-2">
